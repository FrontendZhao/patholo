...
!function(a) {
	...
	a.type = function(a) {
		return null === a || void 0 === a ? String(a) : b[c.call(a)]
				|| "object"
	};
	a.isPlainObject = function(b) {
		if (!b || "object" !== OpenSeadragon.type(b) || b.nodeType
				|| a.isWindow(b))
			return !1;
		if (b.constructor && !d.call(b, "constructor")
	...
	a.freezeObject = function(b) {
		Object.freeze
				? a.freezeObject = Object.freeze
				: a.freezeObject = function(a) {
					return a
				};
	...
	a.pixelDensityRatio = function() {
		if (a.supportsCanvas) {
			...
			var d = b.webkitBackingStorePixelRatio
					|| b.mozBackingStorePixelRatio
					|| b.msBackingStorePixelRatio || b.oBackingStorePixelRatio
					|| b.backingStorePixelRatio || 1;
...
!function($) {
			...
			if (null !== a || void 0 !== a)
				for (b in a) {
					...
					if (g !== d)
						if (i
								&& d
								&& (OpenSeadragon.isPlainObject(d) || (e = OpenSeadragon
										.isArray(d)))) {
							if (e) {
								e = !1;
								f = c && OpenSeadragon.isArray(c) ? c : []
							} else
								f = c && OpenSeadragon.isPlainObject(c)
										? c
										: {};
	...
	var isIOSDevice = function() {
		...
		return "string" == typeof a
				&& (a.indexOf("iPhone") !== -1 || a.indexOf("iPad") !== -1 || a
						.indexOf("iPod") !== -1)
	};
	$.extend($, {
		DEFAULT_SETTINGS : {
		...
		getElementOffset : function(a) {
			...
			c = d == d.window ? d : 9 === d.nodeType
					&& (d.defaultView || d.parentWindow);
			return new $.Point(e.left + (c.pageXOffset || b.scrollLeft)
							- (b.clientLeft || 0), e.top
		...
		getCssPropertyWithVendorPrefix : function(a) {
			...
			$.getCssPropertyWithVendorPrefix = function(a) {
				...
				if (void 0 !== c[a])
					...
					var e = ["Webkit", "Moz", "MS", "O", "webkit", "moz", "ms",
							"o"];
		...
		pointInElement : function(a, b) {
			...
			return b.x >= c.x && b.x < c.x + d.x && b.y < c.y + d.y
					&& b.y >= c.y
		},
		getEvent : function(a) {
		...
		getMousePosition : function(a) {
			if ("number" == typeof a.pageX)
				...
				if ("number" != typeof a.clientX)
					throw new Error("Unknown event mouse position, no known technique.");
				$.getMousePosition = function(a) {
					var b = new $.Point;
					a = $.getEvent(a);
					b.x = a.clientX + document.body.scrollLeft
							+ document.documentElement.scrollLeft;
					b.y = a.clientY + document.body.scrollTop
		...
		getPageScroll : function() {
			...
			if ("number" == typeof window.pageXOffset)
				...
				$.getPageScroll = function() {
					return new $.Point(document.body.scrollLeft,
				...
				$.getPageScroll = function() {
					return new $.Point(document.documentElement.scrollLeft,
							document.documentElement.scrollTop)
				}
			}
		...
		getWindowSize : function() {
			...
			if ("number" == typeof window.innerWidth)
				...
				$.getWindowSize = function() {
					return new $.Point(document.documentElement.clientWidth,
				...
				$.getWindowSize = function() {
					return new $.Point(document.body.clientWidth,
		...
		makeCenteredNode : function(a) {
			a = $.getElement(a);
			var b = [$.makeNeutralElement("div"), $.makeNeutralElement("div"),
		...
		makeTransparentImage : function(a) {
			...
			$.Browser.vendor == $.BROWSERS.IE && $.Browser.version < 7
					&& ($.makeTransparentImage = function(a) {
						...
						b.src = a;
						c.style.filter = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='"
		...
		setElementTouchActionNone : function(a) {
			a = $.getElement(a);
			"undefined" != typeof a.style.touchAction
					? a.style.touchAction = "none"
					: "undefined" != typeof a.style.msTouchAction
		...
		createAjaxRequest : function(a) {
			...
			if (b)
				window.XMLHttpRequest ? $.createAjaxRequest = function(a) {
					return a
		...
		makeAjaxRequest : function(a, b, c) {
			...
			h.onreadystatechange = function() {
				if (4 == h.readyState) {
					...
					if (h.status >= 200 && h.status < 300 || 0 === h.status
							&& "http:" !== g && "https:" !== g)
						b(h);
					else {
						$.console.log("AJAX request returned %d: %s", h.status,
								a);
						$.isFunction(c) && c(h)
					}
				}
				...
				if (e)
					for (var i in e)
						e.hasOwnProperty(i) && e[i]
								&& h.setRequestHeader(i, e[i]);
				d && (h.withCredentials = !0);
				h.send(null)
			} catch (d) {
				var j = d.message;
				var k = $.Browser.vendor == $.BROWSERS.IE
						&& $.Browser.version < 10;
				k
						&& "undefined" != typeof d.number
						&& d.number == -2147024891
		...
		jsonp : function(a) {
			var b, c = a.url, d = document.head
					|| document.getElementsByTagName("head")[0]
					|| document.documentElement, e = a.callbackName
					|| "openseadragon" + $.now(), f = window[e], g = "$1" + e
					+ "$2", h = a.param || "callback", i = a.callback;
			c = c.replace(/(\=)\?(&|$)|\?\?/i, g);
			c += (/\?/.test(c) ? "&" : "?") + h + "=" + e;
			window[e] = function(a) {
				if (f)
	...
	!function() {
		...
		switch (navigator.appName) {
			case "Microsoft Internet Explorer" :
				if (window.attachEvent && window.ActiveXObject) {
					...
					$.Browser.version = parseFloat(c.substring(c
									.indexOf("MSIE")
									+ 5, c.indexOf(";", c.indexOf("MSIE"))))
				}
				break;
			case "Netscape" :
				if (window.addEventListener)
					if (c.indexOf("Firefox") >= 0) {
						...
						$.Browser.vendor = c.indexOf("Chrome") >= 0
								? $.BROWSERS.CHROME
								: $.BROWSERS.SAFARI;
						$.Browser.version = parseFloat(c.substring(c.substring(
										0, c.indexOf("Safari"))
										.lastIndexOf("/")
										+ 1, c.indexOf("Safari")))
					} else {
		...
		for (f = 0; f < h.length; f++) {
			...
			e = d.indexOf("=");
			e > 0
					&& (URLPARAMS[d.substring(0, e)] = decodeURIComponent(d
							.substring(e + 1)))
		}
		$.Browser.alpha = !($.Browser.vendor == $.BROWSERS.IE
				&& $.Browser.version < 9 || $.Browser.vendor == $.BROWSERS.CHROME
				&& $.Browser.version < 2);
	...
	!function(a) {
		var b = a.requestAnimationFrame || a.mozRequestAnimationFrame
				|| a.webkitRequestAnimationFrame || a.msRequestAnimationFrame;
		var c = a.cancelAnimationFrame || a.mozCancelAnimationFrame
				|| a.webkitCancelAnimationFrame || a.msCancelAnimationFrame;
		if (b && c) {
...
!function(a) {
	...
	b.cancelFullScreen = function() {
		a.console
				.error("cancelFullScreen is deprecated. Use exitFullScreen instead.");
		b.exitFullScreen()
	};
	a.extend(a, b)
}(OpenSeadragon);
...
!function(a) {
	function b(b) {
		...
		for (c = 0; c < e; c++)
			if (d.activePointersLists[c].captureCount > 0) {
				a.removeEvent(a.MouseTracker.captureElement, "mousemove",
						d.mousemovecaptured, !0);
				a.removeEvent(a.MouseTracker.captureElement, "mouseup",
						d.mouseupcaptured, !0);
				a.removeEvent(a.MouseTracker.captureElement,
						a.MouseTracker.unprefixedPointerEvents
								? "pointermove"
								: "MSPointerMove", d.pointermovecaptured, !0);
				a.removeEvent(a.MouseTracker.captureElement,
						a.MouseTracker.unprefixedPointerEvents
								? "pointerup"
								: "MSPointerUp", d.pointerupcaptured, !0);
				a.removeEvent(a.MouseTracker.captureElement, "touchmove",
						d.touchmovecaptured, !0);
				a.removeEvent(a.MouseTracker.captureElement, "touchend",
						d.touchendcaptured, !0);
	...
	function e(b, c) {
		...
		if ("pointerevent" === c)
			return {
				upName : a.MouseTracker.unprefixedPointerEvents
						? "pointerup"
						: "MSPointerUp",
				upHandler : d.pointerupcaptured,
				moveName : a.MouseTracker.unprefixedPointerEvents
						? "pointermove"
						: "MSPointerMove",
	...
	function f(b, c, d) {
		...
		if (1 === g.captureCount)
			if (a.Browser.vendor === a.BROWSERS.IE && a.Browser.version < 9)
				...
				qa && na(window.top)
						&& a.addEvent(window.top, f.upName, f.upHandler, !0);
				a.addEvent(a.MouseTracker.captureElement, f.upName,
						f.upHandler, !0);
				a.addEvent(a.MouseTracker.captureElement, f.moveName,
						f.moveHandler, !0)
			}
	}
	function g(b, c, d) {
		...
		if (0 === g.captureCount)
			if (a.Browser.vendor === a.BROWSERS.IE && a.Browser.version < 9)
				...
				f = e(b, a.MouseTracker.havePointerEvents ? "pointerevent" : c);
				qa && na(window.top)
						&& a.removeEvent(window.top, f.upName, f.upHandler, !0);
				a.removeEvent(a.MouseTracker.captureElement, f.moveName,
						f.moveHandler, !0);
				a.removeEvent(a.MouseTracker.captureElement, f.upName,
						f.upHandler, !0)
			}
	}
	function h(b) {
	...
	function u(b, c) {
		...
		"mousewheel" == a.MouseTracker.wheelEventName
				? d.deltaY = -c.wheelDelta
						/ a.DEFAULT_SETTINGS.pixelsPerWheelLine
				: d.deltaY = c.detail;
		v(b, d, c)
	}
	function v(b, c, d) {
	...
	function y(b, c) {
		...
		c.currentTarget === c.relatedTarget
				|| w(c.currentTarget, c.relatedTarget) || z(b, c)
	}
	function z(b, c) {
		var d = {
	...
	function B(b, c) {
		c = a.getEvent(c);
		c.currentTarget === c.relatedTarget
				|| w(c.currentTarget, c.relatedTarget) || C(b, c)
	}
	function C(b, c) {
		var d = {
			id : a.MouseTracker.mousePointerId,
	...
	function D(b) {
		return a.Browser.vendor === a.BROWSERS.IE && a.Browser.version < 9
				? 1 === b ? 0 : 2 === b ? 2 : 4 === b ? 1 : -1
				: b
	}
	function E(b, c) {
		...
		(b.clickHandler || b.dblClickHandler || b.pressHandler || b.dragHandler || b.dragEndHandler)
				&& a.cancelEvent(c)
	}
	function F(a, b) {
		H(a, b)
	...
	function M(b, c) {
		var d, e, g, h, j = c.changedTouches.length, k = [], l = b
				.getActivePointersListByType("touch");
		d = a.now();
		if (l.getLength() > c.touches.length - j) {
			a.console
					.warn("Tracked touch contact count doesn't match event.touches.length. Removing all tracked touch pointers.");
			L(b, c, l)
		}
		for (e = 0; e < j; e++)
			k.push({
		...
		for (e = 0; e < oa.length; e++)
			if (oa[e] !== b && oa[e].isTracking()
					&& w(oa[e].element, b.element)) {
				h = [];
				for (g = 0; g < j; g++)
					h.push({
	...
	function Y(b, c) {
		...
		(b.clickHandler || b.dblClickHandler || b.pressHandler || b.dragHandler
				|| b.dragEndHandler || b.pinchHandler)
				&& a.cancelEvent(c)
	}
	function Z(a, b) {
		_(a, b)
	...
	function ea(a, b) {
		b.hasOwnProperty("isPrimary")
				|| (0 === a.getLength() ? b.isPrimary = !0 : b.isPrimary = !1);
		b.speed = 0;
		b.direction = 0;
		...
		for (e = 0; e < j; e++) {
			...
			if (b.exitHandler) {
				h = b.exitHandler({
							...
							buttons : i.buttons,
							pointers : b.getActivePointerCount(),
							insideElementPressed : !!g
									&& g.insideElementPressed,
							buttonDownAny : 0 !== i.buttons,
							isTouchEvent : "touch" === f.type,
							originalEvent : c,
							preventDefaultAction : !1,
	...
	function ia(b, c, d, e) {
		var f, g, h, i, j = pa[b.hash], m = b
				.getActivePointersListByType(d[0].type), n = d.length;
		"undefined" != typeof c.buttons
				? m.buttons = c.buttons
		...
		for (g = 0; g < n; g++) {
			...
			m.addContact();
			(b.dragHandler || b.dragEndHandler || b.pinchHandler)
					&& a.MouseTracker.gesturePointVelocityTracker
							.addPoint(b, h);
			if (1 === m.contacts) {
				if (b.pressHandler) {
					f = b.pressHandler({
				...
				j.lastPinchDist = j.currentPinchDist = j.pinchGPoints[0].currentPos
						.distanceTo(j.pinchGPoints[1].currentPos);
				j.lastPinchCenter = j.currentPinchCenter = l(
						j.pinchGPoints[0].currentPos,
						j.pinchGPoints[1].currentPos)
			}
		}
		return !0
	}
	function ja(b, c, d, e) {
		var f, g, h, i, j, m, n, o = pa[b.hash], p = b
				.getActivePointersListByType(d[0].type), q = d.length, r = !1, s = !1;
		"undefined" != typeof c.buttons
				? p.buttons = c.buttons
				: a.Browser.vendor === a.BROWSERS.IE && a.Browser.version < 9
						? 0 === e ? p.buttons -= 1 : 1 === e
								...
								: 2 === e ? p.buttons -= 2 : 3 === e
										? p.buttons -= 8
										: 4 === e ? p.buttons -= 16 : 5 === e
												&& (p.buttons -= 32)
						: 0 === e ? p.buttons ^= -2 : 1 === e
								? p.buttons ^= -5
								: 2 === e ? p.buttons ^= -3 : 3 === e
										? p.buttons ^= -9
										: 4 === e ? p.buttons ^= -17 : 5 === e
												&& (p.buttons ^= -33);
		if (0 !== e) {
			...
			if (m) {
				...
				if (s) {
					...
					if (0 === p.contacts) {
						...
						if (b.dragEndHandler
								&& !m.currentPos.equals(m.contactPos)) {
							f = b.dragEndHandler({
										eventSource : b,
										pointerType : m.type,
						...
						if ((b.clickHandler || b.dblClickHandler)
								&& m.insideElement) {
							n = h - m.contactTime <= b.clickTimeThreshold
									&& m.contactPos.distanceTo(g) <= b.clickDistThreshold;
							if (b.clickHandler) {
								f = b.clickHandler({
											eventSource : b,
											pointerType : m.type,
											position : k(m.currentPos,
													b.element),
											quick : n,
											shift : c.shiftKey,
											isTouchEvent : "touch" === m.type,
					...
					} else if (2 === p.contacts && b.pinchHandler
							&& "touch" === m.type) {
						o.pinchGPoints = p.asArray();
						o.lastPinchDist = o.currentPinchDist = o.pinchGPoints[0].currentPos
								.distanceTo(o.pinchGPoints[1].currentPos);
						o.lastPinchCenter = o.currentPinchCenter = l(
	...
	function ka(b, c, d) {
		var e, f, g, h, i, j, m = pa[b.hash], n = b
				.getActivePointersListByType(d[0].type), o = d.length;
		...
		if (0 === n.contacts) {
			...
			if (b.pinchHandler && "touch" === d[0].type) {
				i = m.pinchGPoints[0].currentPos
						.distanceTo(m.pinchGPoints[1].currentPos);
				if (i != m.currentPinchDist) {
					m.lastPinchDist = m.currentPinchDist;
					m.currentPinchDist = i;
					m.lastPinchCenter = m.currentPinchCenter;
					m.currentPinchCenter = l(m.pinchGPoints[0].currentPos,
	...
	a.MouseTracker = function(b) {
		...
		this.clickTimeThreshold = b.clickTimeThreshold
				|| a.DEFAULT_SETTINGS.clickTimeThreshold;
		this.clickDistThreshold = b.clickDistThreshold
				|| a.DEFAULT_SETTINGS.clickDistThreshold;
		this.dblClickTimeThreshold = b.dblClickTimeThreshold
				|| a.DEFAULT_SETTINGS.dblClickTimeThreshold;
		this.dblClickDistThreshold = b.dblClickDistThreshold
				|| a.DEFAULT_SETTINGS.dblClickDistThreshold;
	...
	a.MouseTracker.prototype = {
		...
		getActivePointersListsExceptType : function(a) {
			var b = pa[this.hash];
			var c = [];
			for (var d = 0; d < b.activePointersLists.length; ++d)
				b.activePointersLists[d].type !== a
						&& c.push(b.activePointersLists[d]);
			return c
		},
	...
	a.MouseTracker.gesturePointVelocityTracker = function() {
		...
		var f = function() {
			...
			for (c = 0; c < j; c++) {
				e = b[c];
				f = e.gPoint;
				f.direction = Math.atan2(f.currentPos.y - e.lastPos.y,
						f.currentPos.x - e.lastPos.x);
	...
	a.MouseTracker.wheelEventName = a.Browser.vendor == a.BROWSERS.IE
			&& a.Browser.version > 8
	...
	a.MouseTracker.subscribeEvents = ["click", "dblclick", "keydown", "keyup",
			"keypress", "focus", "blur", a.MouseTracker.wheelEventName];
	"DOMMouseScroll" == a.MouseTracker.wheelEventName
			&& a.MouseTracker.subscribeEvents.push("MozMousePixelScroll");
	if (window.PointerEvent
			&& (window.navigator.pointerEnabled || a.Browser.vendor !== a.BROWSERS.IE)) {
		a.MouseTracker.havePointerEvents = !0;
		a.MouseTracker.subscribeEvents.push("pointerover", "pointerout",
				"pointerdown", "pointerup", "pointermove", "pointercancel");
		a.MouseTracker.unprefixedPointerEvents = !0;
		navigator.maxTouchPoints
				? a.MouseTracker.maxTouchPoints = navigator.maxTouchPoints
				: a.MouseTracker.maxTouchPoints = 0;
		a.MouseTracker.haveMouseEnter = !1
	} else if (window.MSPointerEvent && window.navigator.msPointerEnabled) {
		a.MouseTracker.havePointerEvents = !0;
		a.MouseTracker.subscribeEvents.push("MSPointerOver", "MSPointerOut",
				"MSPointerDown", "MSPointerUp", "MSPointerMove",
				"MSPointerCancel");
		a.MouseTracker.unprefixedPointerEvents = !1;
		navigator.msMaxTouchPoints
				? a.MouseTracker.maxTouchPoints = navigator.msMaxTouchPoints
				: a.MouseTracker.maxTouchPoints = 0;
		a.MouseTracker.haveMouseEnter = !1
	} else {
		...
		a.MouseTracker.subscribeEvents
				.push("mousedown", "mouseup", "mousemove");
		"ontouchstart" in window
				&& a.MouseTracker.subscribeEvents.push("touchstart",
						"touchend", "touchmove", "touchcancel");
		"ongesturestart" in window
				&& a.MouseTracker.subscribeEvents.push("gesturestart",
						"gesturechange");
	...
	a.MouseTracker.GesturePointList.prototype = {
		...
		getPrimary : function(a) {
			var b, c = this._gPoints.length;
			for (b = 0; b < c; b++)
				if (this._gPoints[b].isPrimary)
					return this._gPoints[b];
			return null
		},
		addContact : function() {
			++this.contacts;
			this.contacts > 1 && ("mouse" === this.type || "pen" === this.type)
					&& (this.contacts = 1)
		},
...
!function(a) {
	...
	a.Control = function(b, c, d) {
		...
		if ("number" == typeof c) {
			a.console
					.error("Passing an anchor directly into the OpenSeadragon.Control constructor is deprecated; please use an options object instead.  Support for this deprecated variant is scheduled for removal in December 2013");
			c = {
				anchor : c
			}
		}
		c.attachToViewer = "undefined" == typeof c.attachToViewer
				|| c.attachToViewer;
		...
		if (this.anchor == a.ControlAnchor.ABSOLUTE) {
			...
			this.wrapper.style.top = "number" == typeof c.top
					? c.top + "px"
					: c.top;
			this.wrapper.style.left = "number" == typeof c.left
					? c.left + "px"
					: c.left;
			this.wrapper.style.height = "number" == typeof c.height ? c.height
					+ "px" : c.height;
			this.wrapper.style.width = "number" == typeof c.width ? c.width
					+ "px" : c.width;
		...
		c.attachToViewer ? this.anchor == a.ControlAnchor.TOP_RIGHT
				|| this.anchor == a.ControlAnchor.BOTTOM_RIGHT
				? this.container.insertBefore(this.wrapper,
						this.container.firstChild)
				: this.container.appendChild(this.wrapper) : e
	...
	a.Control.prototype = {
		...
		setVisible : function(b) {
			this.wrapper.style.display = b
					? this.anchor == a.ControlAnchor.ABSOLUTE
							? "block"
							: "inline-block"
					: "none"
		},
		setOpacity : function(b) {
			this.element[a.SIGNAL] && a.Browser.vendor == a.BROWSERS.IE ? a
					.setElementOpacity(this.element, b, !0) : a
					.setElementOpacity(this.wrapper, b, !0)
		}
	}
}(OpenSeadragon);
!function(a) {
...
!function(a) {
	function b(b) {
		b = a.getElement(b);
		return new a.Point(0 === b.clientWidth ? 1 : b.clientWidth,
				0 === b.clientHeight ? 1 : b.clientHeight)
	}
	function c(b, c, d, e, f) {
		...
		setTimeout(function() {
			if ("string" == a.type(c)) {
				c = new a.TileSource({
							url : c,
							crossOriginPolicy : void 0 !== d.crossOriginPolicy
									? d.crossOriginPolicy
									: b.crossOriginPolicy,
				...
				void 0 !== c.crossOriginPolicy
						|| void 0 === d.crossOriginPolicy
						&& void 0 === b.crossOriginPolicy
						|| (c.crossOriginPolicy = void 0 !== d.crossOriginPolicy
								? d.crossOriginPolicy
								: b.crossOriginPolicy);
				void 0 === c.ajaxWithCredentials
						&& (c.ajaxWithCredentials = b.ajaxWithCredentials);
	...
	function d(b, c) {
		if (c instanceof a.Overlay)
			return c;
		var d = null;
		if (c.element)
			d = a.getElement(c.element);
		else {
			var e = c.id ? c.id : "openseadragon-overlay-"
		...
		if (!f) {
			...
			var j = c.y;
			if (void 0 !== c.px) {
				var k = b.viewport.imageToViewportRectangle(new a.Rect(c.px,
						c.py, g || 0, h || 0));
				i = k.x;
				j = k.y;
		...
		var l = c.placement;
		l && "string" === a.type(l)
				&& (l = a.Placement[c.placement.toUpperCase()]);
	...
	function i(b) {
		...
		if (b.controlsShouldFade) {
			...
			e = Math.min(1, e);
			e = Math.max(0, e);
			for (f = b.controls.length - 1; f >= 0; f--)
				b.controls[f].autoFade && b.controls[f].setOpacity(e);
			e > 0 && g(b)
		}
	}
	function j(a) {
		...
		for (b = a.controls.length - 1; b >= 0; b--)
	...
	function m(b) {
		if (b.preventDefaultAction || b.ctrl || b.alt || b.meta)
			return !0;
		switch (b.keyCode) {
			case 38 :
				b.shift ? this.viewport.zoomBy(1.1) : this.viewport
						.panBy(this.viewport.deltaPointsFromPixels(new a.Point(
								0, -40)));
				this.viewport.applyConstraints();
				return !1;
			case 40 :
				b.shift ? this.viewport.zoomBy(.9) : this.viewport
						.panBy(this.viewport.deltaPointsFromPixels(new a.Point(
								0, 40)));
				this.viewport.applyConstraints();
				return !1;
			case 37 :
				this.viewport.panBy(this.viewport
						.deltaPointsFromPixels(new a.Point(-40, 0)));
				this.viewport.applyConstraints();
				return !1;
			case 39 :
				this.viewport.panBy(this.viewport
	...
	function o(a) {
		...
		if (!d.preventDefaultAction && this.viewport && a.quick) {
			...
			if (b.clickToZoom) {
				this.viewport.zoomBy(a.shift
								? 1 / this.zoomPerClick
								: this.zoomPerClick, this.viewport
								.pointFromPixel(a.position, !0));
				this.viewport.applyConstraints()
			}
		}
	}
	...
	function q(a) {
		...
		if (!c.preventDefaultAction && this.viewport) {
			b = this.gestureSettingsByDeviceType(a.pointerType);
			...
			this.viewport.panBy(this.viewport.deltaPointsFromPixels(a.delta
							.negate()), b.flickEnabled
	...
	function r(b) {
		if (!b.preventDefaultAction && this.viewport) {
			...
			if (c.flickEnabled && b.speed >= c.flickMinSpeed) {
				var d = 0;
				this.panHorizontal
						&& (d = c.flickMomentum * b.speed
								* Math.cos(b.direction));
				var e = 0;
				this.panVertical
						&& (e = c.flickMomentum * b.speed
								* Math.sin(b.direction));
				var f = this.viewport.pixelFromPoint(this.viewport
						.getCenter(!0));
				var g = this.viewport.pointFromPixel(new a.Point(f.x - d, f.y
								- e));
	...
	function t(b) {
		window.location != window.parent.location
				&& a.MouseTracker.resetAllMouseTrackers();
	...
	function y(a) {
		...
		if (!a.preventDefaultAction && this.viewport) {
			...
			if (b.pinchRotate) {
				var f = Math.atan2(a.gesturePoints[0].currentPos.y
								- a.gesturePoints[1].currentPos.y,
						a.gesturePoints[0].currentPos.x
								- a.gesturePoints[1].currentPos.x);
				var g = Math.atan2(a.gesturePoints[0].lastPos.y
								- a.gesturePoints[1].lastPos.y,
						a.gesturePoints[0].lastPos.x
								- a.gesturePoints[1].lastPos.x);
				this.viewport.setRotation(this.viewport.getRotation() + (f - g)
						* (180 / Math.PI))
			}
		}
		...
		if (f > this.minScrollDeltaTime) {
			...
			if (!b.preventDefaultAction && this.viewport) {
				...
				if (c.scrollToZoom) {
					...
					this.viewport.zoomBy(d, this.viewport.pointFromPixel(
									b.position, !0));
					this.viewport.applyConstraints()
				}
			}
	...
	function P() {
		this.isFullPage() && !a.isFullScreen() ? this.setFullPage(!1) : this
				.setFullScreen(!this.isFullPage());
	...
	a.Viewer = function(c) {
		...
		if ("undefined" == typeof this.hash)
			throw new Error("A hash must be defined, either by specifying options.id or options.hash.");
		"undefined" != typeof U[this.hash]
				&& a.console.warn("Hash " + this.hash
		...
		this.addHandler("open-failed", function(b) {
					var c = a.getString("Errors.OpenFailed", b.eventSource,
							b.message);
					g._showMessage(c)
				});
		...
		"" !== c.tabIndex
				&& (this.canvas.tabIndex = void 0 === c.tabIndex
						? 0
						: c.tabIndex);
		...
		this.world.addHandler("metrics-change", function(a) {
					g.viewport
							&& g.viewport._setContentBounds(g.world
											.getHomeBounds(), g.world
											.getContentFactor())
				});
		...
		this.viewport._setContentBounds(this.world.getHomeBounds(), this.world
						.getContentFactor());
		...
		for (d = 0; d < this.customControls.length; d++)
			this.addControl(this.customControls[d].id, {
	...
	a.extend(a.Viewer.prototype, a.EventSource.prototype,
			a.ControlDock.prototype, {
				isOpen : function() {
				...
				openDzi : function(b) {
					a.console
							.error("[Viewer.openDzi] this function is deprecated; use Viewer.open() instead.");
					return this.open(b)
				},
				...
				open : function(b, c) {
					...
					if (b)
						if (this.sequenceMode && a.isArray(b)) {
							...
							"undefined" == typeof c || isNaN(c)
									|| (this.initialPage = c);
							this.tileSources = b;
							this._sequenceIndex = Math.max(0, Math.min(
											this.tileSources.length - 1,
											this.initialPage));
							if (this.tileSources.length) {
								this
										.open(this.tileSources[this._sequenceIndex]);
							...
							if (b.length) {
								...
								var j = function() {
									if (g + h === f)
										if (g) {
											...
											if (e.overlays
													&& !e.preserveOverlays)
												for (var c = 0; c < e.overlays.length; c++)
													e.currentOverlays[c] = d(e,
															e.overlays[c]);
											e._drawOverlays();
											e._opening = !1;
											e.raiseEvent("open", {
								...
								var k = function(b) {
									a.isPlainObject(b) && b.tileSource
											|| (b = {
												tileSource : b
											});
									if (void 0 !== b.index) {
										a.console
												.error("[Viewer.open] setting indexes here is not supported; use addTiledImage instead");
										delete b.index
									}
									void 0 === b.collectionImmediately
											&& (b.collectionImmediately = !0);
									var c = b.success;
									b.success = function(a) {
										g++;
										if (b.tileSource.overlays)
											for (var d = 0; d < b.tileSource.overlays.length; d++)
												e
														.addOverlay(b.tileSource.overlays[d]);
										c && c(a);
										j()
									};
									var d = b.error;
				...
				setDebugMode : function(a) {
					for (var b = 0; b < this.world.getItemCount(); b++)
						this.world.getItemAt(b).debugMode = a;
					this.debugMode = a;
					this.forceRedraw()
				},
				isFullPage : function() {
				...
				setFullPage : function(b) {
					...
					if (b) {
						...
						U[this.hash].prevElementParent.insertBefore(
								this.element, U[this.hash].prevNextSibling);
						if (this.toolbar && this.toolbar.element) {
						...
						var k = function() {
							...
							j++;
							j < 10
									&& (b.x !== h.pageScroll.x || b.y !== h.pageScroll.y)
				...
				setFullScreen : function(b) {
					...
					if (b) {
						...
						var e = function() {
							...
							if (!b) {
								a.removeEvent(document, a.fullScreenEventName,
										e);
								a.removeEvent(document,
										a.fullScreenErrorEventName, e);
								c.setFullPage(!1);
								if (c.isFullPage()) {
				...
				addTiledImage : function(b) {
					...
					function f() {
						...
						for (; g._loadQueue.length;) {
							...
							if (b.options.replace) {
								var f = g.world
										.getIndexOfItem(b.options.replaceItem);
							...
							g.collectionMode
									&& g.world.setAutoRefigureSizes(!1);
							g.world.addItem(c, {
										index : b.options.index
									});
							0 === g._loadQueue.length && e(b);
							1 !== g.world.getItemCount() || g.preserveViewport
									|| g.viewport.goHome(!0);
							if (g.navigator) {
					...
					this._hideMessage();
					void 0 === b.placeholderFillStyle
							&& (b.placeholderFillStyle = this.placeholderFillStyle);
					void 0 === b.opacity && (b.opacity = this.opacity);
					void 0 === b.preload && (b.preload = this.preload);
					void 0 === b.compositeOperation
							&& (b.compositeOperation = this.compositeOperation);
					void 0 === b.crossOriginPolicy
							&& (b.crossOriginPolicy = void 0 !== b.tileSource.crossOriginPolicy
									? b.tileSource.crossOriginPolicy
									: this.crossOriginPolicy);
					void 0 === b.ajaxWithCredentials
							&& (b.ajaxWithCredentials = this.ajaxWithCredentials);
					void 0 === b.loadTilesWithAjax
							&& (b.loadTilesWithAjax = this.loadTilesWithAjax);
					void 0 === b.ajaxHeaders || null === b.ajaxHeaders
							? b.ajaxHeaders = this.ajaxHeaders
							: a.isPlainObject(b.ajaxHeaders)
									&& a.isPlainObject(this.ajaxHeaders)
									&& (b.ajaxHeaders = a.extend({},
											this.ajaxHeaders, b.ajaxHeaders));
					var h = {
						options : b
					};
					if (a.isArray(b.tileSource))
						setTimeout(function() {
							d({
				...
				addLayer : function(b) {
					var c = this;
					a.console
							.error("[Viewer.addLayer] this function is deprecated; use Viewer.addTiledImage() instead.");
					var d = a.extend({}, b, {
								success : function(a) {
				...
				getLayerAtLevel : function(b) {
					a.console
							.error("[Viewer.getLayerAtLevel] this function is deprecated; use World.getItemAt() instead.");
					return this.world.getItemAt(b)
				},
				getLevelOfLayer : function(b) {
					a.console
							.error("[Viewer.getLevelOfLayer] this function is deprecated; use World.getIndexOfItem() instead.");
					return this.world.getIndexOfItem(b)
				},
				getLayersCount : function() {
					a.console
							.error("[Viewer.getLayersCount] this function is deprecated; use World.getItemCount() instead.");
					return this.world.getItemCount()
				},
				...
				removeLayer : function(b) {
					a.console
							.error("[Viewer.removeLayer] this function is deprecated; use World.removeItem() instead.");
				...
				bindSequenceControls : function() {
					var b = a.delegate(this, k), c = a.delegate(this, l), d = a
							.delegate(this, T), e = a.delegate(this, S), f = this.navImages, g = !0;
					if (this.showSequenceControl) {
						(this.previousButton || this.nextButton) && (g = !1);
						this.previousButton = new a.Button({
									element : this.previousButton
											? a.getElement(this.previousButton)
											: null,
									clickTimeThreshold : this.clickTimeThreshold,
									clickDistThreshold : this.clickDistThreshold,
									tooltip : a
									...
									srcGroup : F(this.prefixUrl,
											f.previous.GROUP),
									srcHover : F(this.prefixUrl,
											f.previous.HOVER),
						...
						this.nextButton = new a.Button({
									element : this.nextButton ? a
											.getElement(this.nextButton) : null,
									clickTimeThreshold : this.clickTimeThreshold,
									clickDistThreshold : this.clickDistThreshold,
				...
				bindStandardControls : function() {
					var b = a.delegate(this, G), c = a.delegate(this, I), d = a
							.delegate(this, L), e = a.delegate(this, H), f = a
							.delegate(this, M), g = a.delegate(this, O), h = a
							.delegate(this, P), i = a.delegate(this, Q), j = a
							.delegate(this, R), m = a.delegate(this, k), n = a
							.delegate(this, l), o = this.navImages, p = [], q = !0;
					if (this.showNavigationControl) {
						(this.zoomInButton || this.zoomOutButton
						...
						if (this.showZoomControl) {
							p.push(this.zoomInButton = new a.Button({
										...
										srcRest : F(this.prefixUrl,
												o.zoomIn.REST),
										srcGroup : F(this.prefixUrl,
												o.zoomIn.GROUP),
										srcHover : F(this.prefixUrl,
												o.zoomIn.HOVER),
										srcDown : F(this.prefixUrl,
												o.zoomIn.DOWN),
										onPress : b,
										onRelease : c,
										onClick : d,
						...
						this.showHomeControl
								&& p.push(this.homeButton = new a.Button({
									element : this.homeButton ? a
						...
						this.showFullPageControl
								&& p.push(this.fullPageButton = new a.Button({
									element : this.fullPageButton
											? a.getElement(this.fullPageButton)
											: null,
									clickTimeThreshold : this.clickTimeThreshold,
									clickDistThreshold : this.clickDistThreshold,
						...
						if (this.showRotationControl) {
							p.push(this.rotateLeftButton = new a.Button({
								element : this.rotateLeftButton
										? a.getElement(this.rotateLeftButton)
										: null,
								clickTimeThreshold : this.clickTimeThreshold,
								clickDistThreshold : this.clickDistThreshold,
							...
							p.push(this.rotateRightButton = new a.Button({
								element : this.rotateRightButton
										? a.getElement(this.rotateRightButton)
										: null,
								clickTimeThreshold : this.clickTimeThreshold,
								clickDistThreshold : this.clickDistThreshold,
						...
						if (q) {
							...
							this.toolbar ? this.toolbar.addControl(
									this.navControl, {
										anchor : this.navigationControlAnchor
												|| a.ControlAnchor.TOP_LEFT
				...
				_drawOverlays : function() {
					...
					for (a = 0; a < b; a++)
						this.currentOverlays[a].drawHTML(
								this.overlaysContainer, this.viewport)
				},
				...
				addReferenceStrip : function() {
					...
					if (this.sequenceMode) {
						...
						a.console
								.warn('Attempting to display a reference strip while "sequenceMode" is off.')
				}
			})
}(OpenSeadragon);
!function(a) {
	function b(a) {
		if (a.quick && this.viewer.viewport) {
			this.viewer.viewport
					.panTo(this.viewport.pointFromPixel(a.position));
	...
	a.Navigator = function(g) {
		...
		if (g.id) {
			...
			if (g.position)
				if ("BOTTOM_RIGHT" == g.position)
					g.controlOptions.anchor = a.ControlAnchor.BOTTOM_RIGHT;
				else if ("BOTTOM_LEFT" == g.position)
					g.controlOptions.anchor = a.ControlAnchor.BOTTOM_LEFT;
				else if ("TOP_RIGHT" == g.position)
					g.controlOptions.anchor = a.ControlAnchor.TOP_RIGHT;
				else if ("TOP_LEFT" == g.position)
					g.controlOptions.anchor = a.ControlAnchor.TOP_LEFT;
		...
		this.totalBorderWidths = new a.Point(2 * this.borderWidth, 2
						* this.borderWidth).minus(this.fudge);
		...
		this.displayRegionContainer.id = this.element.id
				+ "-displayregioncontainer";
		this.displayRegionContainer.className = "displayregioncontainer";
		this.displayRegionContainer.style.width = "100%";
		this.displayRegionContainer.style.height = "100%";
		k.addControl(this.element, g.controlOptions);
		this._resizeWithViewer = g.controlOptions.anchor != a.ControlAnchor.ABSOLUTE
				&& g.controlOptions.anchor != a.ControlAnchor.NONE;
		if (this._resizeWithViewer) {
			if (g.width && g.height) {
				this.element.style.height = "number" == typeof g.height
						? g.height + "px"
						: g.height;
				this.element.style.width = "number" == typeof g.width ? g.width
						+ "px" : g.width
			} else {
				i = a.getElementSize(k.element);
				this.element.style.height = Math.round(i.y * g.sizeRatio)
						+ "px";
		...
		this.element.getElementsByTagName("div")[0]
				.appendChild(this.displayRegionContainer);
		if (g.navigatorRotate) {
			var m = g.viewer.viewport
					? g.viewer.viewport.getRotation()
					: g.viewer.degrees || 0;
			h(m);
	...
	a.extend(a.Navigator.prototype, a.EventSource.prototype,
			a.Viewer.prototype, {
				updateSize : function() {
					if (this.viewport) {
						var b = new a.Point(0 === this.container.clientWidth
										? 1
				...
				update : function(b) {
					...
					if (this._resizeWithViewer && c.x && c.y
					...
					if (b && this.viewport) {
						...
						g = this.viewport.pixelFromPointNoRotate(
								f.getTopLeft(), !1);
						h = this.viewport.pixelFromPointNoRotate(
								f.getBottomRight(), !1)
								.minus(this.totalBorderWidths);
						var i = this.displayRegion.style;
						i.display = this.world.getItemCount()
								? "block"
								: "none";
				...
				addTiledImage : function(b) {
					...
					var e = a.extend({}, b, {
								success : function(a) {
									...
									d.addHandler("composite-operation-change",
											f)
								}
							});
...
!function(a) {
	function b(b) {
		...
		if (!b)
			throw new Error(a.getString("Errors.Security"));
		...
		if (e.match(/\s*<.*/))
			try {
				d = b.responseXML && b.responseXML.documentElement
						? b.responseXML
						: a.parseXml(e)
			} catch (a) {
				d = b.responseText
	...
	a.TileSource = function(b, c, d, e, f, g) {
		...
		if (this.url) {
			...
			this.maxLevel = void 0 !== i.maxLevel && null !== i.maxLevel
					? i.maxLevel
					: i.width && i.height ? Math.ceil(Math.log(Math.max(
							i.width, i.height))
							/ Math.log(2)) : 0;
	...
	a.TileSource.prototype = {
		getTileSize : function(b) {
			a.console
					.error("[TileSource.getTileSize] is deprecated.Use TileSource.getTileWidth() and TileSource.getTileHeight() instead");
		...
		getNumTiles : function(b) {
			var c = this.getLevelScale(b), d = Math.ceil(c * this.dimensions.x
					/ this.getTileWidth(b)), e = Math.ceil(c
					* this.dimensions.y / this.getTileHeight(b));
			return new a.Point(d, e)
		},
		getPixelRatio : function(b) {
			var c = this.dimensions.times(this.getLevelScale(b)), d = 1 / c.x, e = 1
					/ c.y;
			return new a.Point(d, e)
		},
		...
		getTileAtPoint : function(b, c) {
			var d = c.x >= 0 && c.x <= 1 && c.y >= 0
					&& c.y <= 1 / this.aspectRatio;
			a.console
					.assert(d,
			...
			var j = 1e-16;
			c.y >= 1 / this.aspectRatio - j && (i = this.getNumTiles(b).y - 1);
			return new a.Point(h, i)
		},
		getTileBounds : function(b, c, d) {
			var e = this.dimensions.times(this.getLevelScale(b)), f = this
					.getTileWidth(b), g = this.getTileHeight(b), h = 0 === c
					? 0
					: f * c - this.tileOverlap, i = 0 === d ? 0 : g * d
					- this.tileOverlap, j = f + (0 === c ? 1 : 2)
					* this.tileOverlap, k = g + (0 === d ? 1 : 2)
					* this.tileOverlap, l = 1 / e.x;
			j = Math.min(j, e.x - h);
			k = Math.min(k, e.y - i);
		...
		getImageInfo : function(c) {
			...
			e = function(b) {
				...
				if (d) {
					...
					void 0 === g.ajaxWithCredentials
							&& (g.ajaxWithCredentials = k.ajaxWithCredentials);
					f = new d(g);
					k.ready = !0;
					k.raiseEvent("ready", {
								tileSource : f
				...
				a.makeAjaxRequest({
							...
							error : function(a, b) {
								...
								try {
									...
									var e;
									e = "undefined" != typeof b && b.toString
											? b.toString()
											: "Unknown error";
		...
		tileExists : function(a, b, c) {
			...
			return a >= this.minLevel && a <= this.maxLevel && b >= 0 && c >= 0
					&& b < d.x && c < d.y
		}
	};
	...
	a.TileSource.determineType = function(b, c, d) {
		...
		for (e in OpenSeadragon)
			if (e.match(/.+TileSource$/) && a.isFunction(OpenSeadragon[e])
					&& a.isFunction(OpenSeadragon[e].prototype.supports)
					&& OpenSeadragon[e].prototype.supports.call(b, c, d))
				return OpenSeadragon[e];
...
!function(a) {
	function b(b, d) {
		...
		if ("Image" == k)
			try {
				...
				if (!a.imageFormatSupported(m.Image.Format))
					throw new Error(a.getString("Errors.ImageFormat",
							m.Image.Format.toUpperCase()));
				e = j.getElementsByTagName("DisplayRect");
				void 0 === e
						&& (e = j.getElementsByTagNameNS(l, "DisplayRect")[0]);
				for (i = 0; i < e.length; i++) {
					f = e[i];
					g = f.getElementsByTagName("Rect")[0];
					void 0 === g
							&& (g = f.getElementsByTagNameNS(l, "Rect")[0]);
					n.push({
						Rect : {
				...
				throw b instanceof Error ? b : new Error(a
	...
	function c(b, c) {
		var d, e, f = c.Image, g = f.Url, h = f.Format, i = f.Size, j = f.DisplayRect
				|| [], k = parseInt(i.Width, 10), l = parseInt(i.Height, 10), m = parseInt(
				f.TileSize, 10), n = parseInt(f.Overlap, 10), o = [];
		for (e = 0; e < j.length; e++) {
			d = j[e].Rect;
			o.push(new a.DisplayRect(parseInt(d.X, 10), parseInt(d.Y, 10),
					parseInt(d.Width, 10), parseInt(d.Height, 10), parseInt(
							d.MinLevel, 10), parseInt(d.MaxLevel, 10)))
		}
		return a.extend(!0, {
					width : k,
					height : l,
	...
	a.extend(a.DziTileSource.prototype, a.TileSource.prototype, {
		supports : function(a, b) {
			...
			a.Image
					? c = a.Image.xmlns
					: a.documentElement
							&& ("Image" != a.documentElement.localName
									&& "Image" != a.documentElement.tagName || (c = a.documentElement.namespaceURI));
			c = (c || "").toLowerCase();
			return c.indexOf("schemas.microsoft.com/deepzoom/2008") !== -1
					|| c.indexOf("schemas.microsoft.com/deepzoom/2009") !== -1
		},
		configure : function(d, e) {
			var f;
			f = a.isPlainObject(d) ? c(this, d) : b(this, d);
			if (e && !f.tilesUrl) {
				f.tilesUrl = e.replace(
						/([^\/]+?)(\.(dzi|xml|js)?(\?[^\/]*)?)?\/?$/,
						"$1_files/");
				e.search(/\.(dzi|xml|js)\?/) != -1 ? f.queryParams = e
						.match(/\?.*/) : f.queryParams = ""
			}
			return f
		},
		getTileUrl : function(a, b, c) {
			return [this.tilesUrl, a, "/", b, "_", c, ".", this.fileFormat,
...
!function(a) {
	...
	function c(a) {
		var b = [];
		for (var c = 0; c < a.sizes.length; c++)
			b.push({
						url : a["@id"] + "/full/" + a.sizes[c].width
								+ ",/0/default.jpg",
	...
	a.IIIFTileSource = function(d) {
		...
		if (this.tile_width && this.tile_height) {
				...
				for (var e = 0; e < this.tiles.length; e++)
					for (var f = 0; f < this.tiles[e].scaleFactors.length; f++) {
						...
						d.tileSizePerScaleFactor[g] = {
							...
							height : this.tiles[e].height
									|| this.tiles[e].width
						}
					}
			}
		else if (b(d.profile)) {
			var h = Math.min(this.height, this.width), i = [256, 512, 1024], j = [];
			for (var k = 0; k < i.length; k++)
				i[k] <= h && j.push(i[k]);
			j.length > 0
					? d.tileSize = Math.max.apply(null, j)
					: d.tileSize = h
			...
			a.console
					.error("Nothing in the info.json to construct image pyramids from");
		d.maxLevel
				|| this.emulateLegacyImagePyramid
				|| (this.scale_factors
						? d.maxLevel = Math.floor(Math.pow(Math.max.apply(null,
										this.scale_factors), .5))
						: d.maxLevel = Number(Math.ceil(Math.log(Math.max(
										this.width, this.height), 2))));
		a.TileSource.apply(this, [d])
	};
	a.extend(a.IIIFTileSource.prototype, a.TileSource.prototype, {
		supports : function(a, b) {
			return !(!a.protocol || "http://iiif.io/api/image" != a.protocol)
					|| (!(!a["@context"] || "http://library.stanford.edu/iiif/image-api/1.1/context.json" != a["@context"]
							&& "http://iiif.io/api/image/1/context.json" != a["@context"]) || (!(!a.profile || 0 !== a.profile
							.indexOf("http://library.stanford.edu/iiif/image-api/compliance.html")) || (!!(a.identifier
							&& a.width && a.height) || !(!a.documentElement
							|| "info" != a.documentElement.tagName || "http://library.stanford.edu/iiif/image-api/ns/" != a.documentElement.namespaceURI))))
		},
		...
		getTileWidth : function(b) {
			if (this.emulateLegacyImagePyramid)
				return a.TileSource.prototype.getTileWidth.call(this, b);
			var c = Math.pow(2, this.maxLevel - b);
			return this.tileSizePerScaleFactor
					&& this.tileSizePerScaleFactor[c]
					? this.tileSizePerScaleFactor[c].width
					: this._tileWidth
		},
		getTileHeight : function(b) {
			if (this.emulateLegacyImagePyramid)
				return a.TileSource.prototype.getTileHeight.call(this, b);
			var c = Math.pow(2, this.maxLevel - b);
			return this.tileSizePerScaleFactor
					&& this.tileSizePerScaleFactor[c]
					? this.tileSizePerScaleFactor[c].height
					: this._tileHeight
		},
		...
		getTileAtPoint : function(b, c) {
			return this.emulateLegacyImagePyramid
					? new a.Point(0, 0)
					: a.TileSource.prototype.getTileAtPoint.call(this, b, c)
		},
		getTileUrl : function(a, b, c) {
			if (this.emulateLegacyImagePyramid) {
				var d = null;
				this.levels.length > 0 && a >= this.minLevel
						&& a <= this.maxLevel && (d = this.levels[a].url);
				return d
			}
			var e, f, g, h, i, j, k, l, m, n, o, p, q = "0", r = Math.pow(.5,
					this.maxLevel - a), s = Math.ceil(this.width * r), t = Math
					.ceil(this.height * r);
			e = this.getTileWidth(a);
			f = this.getTileHeight(a);
			g = Math.ceil(e / r);
			h = Math.ceil(f / r);
			o = this["@context"].indexOf("/1.0/context.json") > -1
...
!function(a) {
	a.TmsTileSource = function(b, c, d, e, f) {
		...
		var h, i = 256 * Math.ceil(g.width / 256), j = 256
				* Math.ceil(g.height / 256);
		h = i > j ? i / 256 : j / 256;
...
!function(a) {
	...
	a.extend(a.ZoomifyTileSource.prototype, a.TileSource.prototype, {
				...
				getTileUrl : function(a, b, c) {
					...
					d = Math.floor(e / 256);
					return this.tilesUrl + "TileGroup" + d + "/" + a + "-" + b
							+ "-" + c + ".jpg"
				}
			})
}(OpenSeadragon);
!function(a) {
	function b(b) {
		...
		for (d = 0; d < b.length; d++) {
			...
			c.height && c.width && c.url ? e.push({
					...
					}) : a.console.error("Unsupported image format: %s", c.url
							? c.url
							: "<no URL>")
		}
	...
	a.extend(a.LegacyTileSource.prototype, a.TileSource.prototype, {
				supports : function(a, b) {
					return a.type
							&& "legacy-image-pyramid" == a.type
							|| a.documentElement
							&& "legacy-image-pyramid" == a.documentElement
									.getAttribute("type")
				},
...
!function(a) {
	...
	a.extend(a.ImageTileSource.prototype, a.TileSource.prototype, {
				...
				getImageInfo : function(b) {
					...
					var d = this;
					this.crossOriginPolicy
							&& (c.crossOrigin = this.crossOriginPolicy);
					this.ajaxWithCredentials
							&& (c.useCredentials = this.ajaxWithCredentials);
					a.addEvent(c, "load", function() {
								d.width = Object.prototype.hasOwnProperty.call(
										c, "naturalWidth")
										? c.naturalWidth
										: c.width;
								d.height = Object.prototype.hasOwnProperty
										.call(c, "naturalHeight")
										? c.naturalHeight
										: c.height;
					...
					a.addEvent(c, "error", function() {
								d.raiseEvent("open-failed", {
											message : "Error loading image at "
													+ b,
											source : b
										})
							});
				...
				getTileUrl : function(a, b, c) {
					var d = null;
					a >= this.minLevel && a <= this.maxLevel
							&& (d = this.levels[a].url);
					return d
				},
				...
				_buildLevels : function() {
					...
					var c = Object.prototype.hasOwnProperty.call(this._image,
							"naturalWidth")
							? this._image.naturalWidth
							: this._image.width;
					var d = Object.prototype.hasOwnProperty.call(this._image,
							"naturalHeight")
							? this._image.naturalHeight
							: this._image.height;
...
!function(a) {
	a.TileSourceCollection = function(b, c, d, e) {
		a.console
				.error("TileSourceCollection is deprecated; use World instead")
	}
}(OpenSeadragon);
!function(a) {
	function b(b) {
...
!function(a) {
	...
	a.Rect.prototype = {
		...
		getTopRight : function() {
			return new a.Point(this.x + this.width, this.y).rotate(
					this.degrees, this.getTopLeft())
		},
		getBottomLeft : function() {
			return new a.Point(this.x, this.y + this.height).rotate(
					this.degrees, this.getTopLeft())
		},
		getCenter : function() {
			return new a.Point(this.x + this.width / 2, this.y + this.height
							/ 2).rotate(this.degrees, this.getTopLeft())
		},
		getSize : function() {
			return new a.Point(this.width, this.height)
		},
		equals : function(b) {
			return b instanceof a.Rect && this.x === b.x && this.y === b.y
					&& this.width === b.width && this.height === b.height
					&& this.degrees === b.degrees
		},
		times : function(b) {
			return new a.Rect(this.x * b, this.y * b, this.width * b,
					this.height * b, this.degrees)
		},
		translate : function(b) {
			return new a.Rect(this.x + b.x, this.y + b.y, this.width,
					this.height, this.degrees)
		},
		union : function(b) {
		...
		intersection : function(b) {
			function c(b, c, e, f) {
				...
				return -d <= j && j <= 1 - d && -d <= k && k <= 1 - d
						? new a.Point(b.x + k * g.x, b.y + k * g.y)
						: null
			}
			var d = 1e-10;
			var e = [];
		...
		rotate : function(b, c) {
			...
			return new a.Rect(d.x, d.y, this.width, this.height, g / Math.PI
							* 180)
		},
		...
		containsPoint : function(a, b) {
			...
			var f = d.minus(c);
			var g = e.minus(c);
			return (a.x - c.x) * f.x + (a.y - c.y) * f.y >= -b
					&& (a.x - d.x) * f.x + (a.y - d.y) * f.y <= b
					&& (a.x - c.x) * g.x + (a.y - c.y) * g.y >= -b
					&& (a.x - e.x) * g.x + (a.y - e.y) * g.y <= b
		},
		toString : function() {
			return "[" + Math.round(100 * this.x) / 100 + ", "
					+ Math.round(100 * this.y) / 100 + ", "
					+ Math.round(100 * this.width) / 100 + "x"
					+ Math.round(100 * this.height) / 100 + ", "
					+ Math.round(100 * this.degrees) / 100 + "deg]"
		}
	}
}(OpenSeadragon);
!function(a) {
	function b(b) {
		var c = Number(this.element.style.marginLeft.replace("px", "")), e = Number(this.element.style.marginTop
				.replace("px", "")), f = Number(this.element.style.width
				.replace("px", "")), g = Number(this.element.style.height
				.replace("px", "")), h = a.getElementSize(this.viewer.canvas);
		this.dragging = !0;
		if (this.element)
			if ("horizontal" == this.scroll) {
				if (-b.delta.x > 0) {
					if (c > -(f - h.x)) {
						this.element.style.marginLeft = c + 2 * b.delta.x
								+ "px";
	...
	function c(b) {
		...
		if (this.element)
			if ("horizontal" == this.scroll) {
				if (b.scroll > 0) {
					if (c > -(f - h.x)) {
						this.element.style.marginLeft = c - 60 * b.scroll
								+ "px";
	...
	function f(b) {
		...
		"horizontal" == this.scroll ? c.style.marginBottom = "-"
				+ a.getElementSize(c).y / 2 + "px" : c.style.marginLeft = "-"
				+ a.getElementSize(c).x / 2 + "px";
		return !1
	}
	function g(a) {
	...
	a.ReferenceStrip = function(j) {
		...
		if (j.width && j.height) {
			...
			this.element.style.width = p.x * j.sizeRatio * o.tileSources.length
					+ 12 * o.tileSources.length + "px";
			this.element.style.height = p.y * j.sizeRatio + "px";
			o.addControl(this.element, {
						anchor : a.ControlAnchor.BOTTOM_LEFT
					})
		} else {
			this.element.style.height = p.y * j.sizeRatio
					* o.tileSources.length + 12 * o.tileSources.length + "px";
		...
		for (m = 0; m < o.tileSources.length; m++) {
			...
			k.innerTracker = new a.MouseTracker({
						...
						releaseHandler : function(b) {
							var c = b.eventSource, d = c.element.id, e = Number(d
									.split("-")[2]), f = a.now();
							if (b.insideElementPressed
									&& b.insideElementReleased && c.dragging
									&& f - c.dragging < c.clickTimeThreshold) {
								c.dragging = null;
								o.goToPage(e)
							}
						}
	...
	a.extend(a.ReferenceStrip.prototype, a.EventSource.prototype,
			a.Viewer.prototype, {
				setFocus : function(b) {
					var c, f = a.getElement(this.element.id + "-" + b), g = a
							.getElementSize(this.viewer.canvas), h = Number(this.element.style.width
							.replace("px", "")), i = Number(this.element.style.height
							.replace("px", "")), j = -Number(this.element.style.marginLeft
							.replace("px", "")), k = -Number(this.element.style.marginTop
							.replace("px", ""));
				...
				destroy : function() {
					if (this.miniViewers)
						for (var a in this.miniViewers)
							this.miniViewers[a].destroy();
					this.element
...
!function(a) {
	...
	a.Spring = function(b) {
		...
		a.console
				.assert("number" == typeof b.springStiffness
								&& 0 !== b.springStiffness,
						"[OpenSeadragon.Spring] options.springStiffness must be a non-zero number");
		a.console
				.assert(
						"number" == typeof b.animationTime
								&& b.animationTime >= 0,
		...
		a.extend(!0, this, b);
		this.current = {
			value : "number" == typeof this.initial
					? this.initial
					: this._exponential ? 0 : 1,
			time : a.now()
		};
		a.console
				.assert(!this._exponential || 0 !== this.current.value,
	...
	a.Spring.prototype = {
		...
		update : function() {
			...
			var e = this.current.time >= this.target.time ? d : c
					+ (d - c)
					* b(this.springStiffness,
							(this.current.time - this.start.time)
									/ (this.target.time - this.start.time));
			var f = this.current.value;
			this._exponential
					? this.current.value = Math.exp(e)
...
!function(a) {
	...
	function c(a, b, c) {
		var d;
		a.jobsInProgress--;
		if ((!a.jobLimit || a.jobsInProgress < a.jobLimit)
				&& a.jobQueue.length > 0) {
			d = a.jobQueue.shift();
			d.start();
			a.jobsInProgress++
...
!function(a) {
	a.Tile = function(a, b, c, d, e, f, g, h, i) {
		...
		this.loadWithAjax = h;
		this.ajaxHeaders = i;
		this.ajaxHeaders ? this.cacheKey = this.url + "+"
				+ JSON.stringify(this.ajaxHeaders) : this.cacheKey = this.url;
		this.loaded = !1;
		this.loading = !1;
		this.element = null;
	...
	a.Tile.prototype = {
		...
		drawHTML : function(b) {
			if (this.cacheImageRecord)
				if (this.loaded) {
					if (!this.element) {
						this.element = a.makeNeutralElement("div");
						this.imgElement = this.cacheImageRecord.getImage()
								.cloneNode();
		...
		drawCanvas : function(b, c, d, e) {
			var f, g = this.position.times(a.pixelDensityRatio), h = this.size
					.times(a.pixelDensityRatio);
			if (this.context2D || this.cacheImageRecord) {
				...
				if (this.loaded && f) {
					...
					1 === b.globalAlpha && this._hasTransparencyChannel()
							&& b.clearRect(g.x + 1, g.y + 1, h.x - 2, h.y - 2);
					c({
								context : b,
								tile : this,
								rendered : f
							});
					b.drawImage(f.canvas, 0, 0, f.canvas.width,
							f.canvas.height, g.x, g.y, h.x, h.y);
					b.restore()
				} else
					a.console
							.warn(
		...
		getScaleForEdgeSmoothing : function() {
			var b;
			if (this.cacheImageRecord)
				b = this.cacheImageRecord.getRenderedContext();
			else {
				if (!this.context2D) {
					a.console
							.warn(
		...
		getTranslationForEdgeSmoothing : function(b, c, d) {
			...
			return new a.Point(e, f).minus(this.position
					.times(a.pixelDensityRatio).times(b || 1).apply(
							function(a) {
								return a % 1
							}))
		},
		unload : function() {
			this.imgElement && this.imgElement.parentNode
...
!function(a) {
	...
	a.Overlay.prototype = {
		_init : function(b) {
			...
			this.placement = void 0 === b.placement
					? a.Placement.TOP_LEFT
					: b.placement;
			...
			this.bounds = new a.Rect(this.location.x, this.location.y,
		...
		adjust : function(b, c) {
			...
			if (d) {
				d.isHorizontallyCentered ? b.x -= c.x / 2 : d.isRight
						&& (b.x -= c.x);
				d.isVerticallyCentered ? b.y -= c.y / 2 : d.isBottom
						&& (b.y -= c.y)
			}
		},
		destroy : function() {
		...
		_getOverlayPositionAndSize : function(b) {
			...
			var e = 0;
			if (b.degrees
					&& this.rotationMode !== a.OverlayRotationMode.NO_ROTATION)
		...
		_getSizeInPixels : function(b) {
			...
			if (null !== this.width || null !== this.height) {
				var e = b.deltaPixelsFromPointsNoRotate(new a.Point(this.width
										|| 0, this.height || 0), !0);
		...
		_getPlacementPoint : function(b) {
			...
			var d = a.Placement.properties[this.placement];
			if (d) {
				d.isHorizontallyCentered ? c.x += b.width / 2 : d.isRight
						&& (c.x += b.width);
				d.isVerticallyCentered ? c.y += b.height / 2 : d.isBottom
						&& (c.y += b.height)
			}
			return c
		},
		...
		_adjustBoundsForRotation : function(b, c) {
			if (!b || 0 === b.degrees
					|| this.rotationMode === a.OverlayRotationMode.EXACT)
				return c;
			if (this.rotationMode === a.OverlayRotationMode.BOUNDING_BOX) {
				if (null === this.width || null === this.height)
					return c;
				var d = this._getOverlayPositionAndSize(b);
				return b.viewerElementToViewportRectangle(new a.Rect(
						d.position.x, d.position.y, d.size.x, d.size.y))
			}
...
!function(a) {
	a.Drawer = function(b) {
		...
		b.source
				&& a.console
						.error("[Drawer] options.source is no longer accepted; use TiledImage instead");
		this.viewer = b.viewer;
		this.viewport = b.viewport;
		this.debugGridColor = "string" == typeof b.debugGridColor
				? [b.debugGridColor]
				: b.debugGridColor || a.DEFAULT_SETTINGS.debugGridColor;
		b.opacity
				&& a.console
						.error("[Drawer] options.opacity is no longer accepted; set the opacity on the TiledImage instead");
		this.useCanvas = a.supportsCanvas
	...
	a.Drawer.prototype = {
		addOverlay : function(b, c, d, e) {
			a.console
					.error("drawer.addOverlay is deprecated. Use viewer.addOverlay instead.");
			this.viewer.addOverlay(b, c, d, e);
			return this
		},
		updateOverlay : function(b, c, d) {
			a.console
					.error("drawer.updateOverlay is deprecated. Use viewer.updateOverlay instead.");
			this.viewer.updateOverlay(b, c, d);
			return this
		},
		removeOverlay : function(b) {
			a.console
					.error("drawer.removeOverlay is deprecated. Use viewer.removeOverlay instead.");
			this.viewer.removeOverlay(b);
			return this
		},
		clearOverlays : function() {
			a.console
					.error("drawer.clearOverlays is deprecated. Use viewer.clearOverlays instead.");
			this.viewer.clearOverlays();
			return this
		},
		setOpacity : function(b) {
			a.console
					.error("drawer.setOpacity is deprecated. Use tiledImage.setOpacity instead.");
			var c = this.viewer.world;
			for (var d = 0; d < c.getItemCount(); d++)
				c.getItemAt(d).setOpacity(b);
			return this
		},
		getOpacity : function() {
			a.console
					.error("drawer.getOpacity is deprecated. Use tiledImage.getOpacity instead.");
		...
		needsUpdate : function() {
			a.console
					.error("[Drawer.needsUpdate] this function is deprecated. Use World.needsDraw instead.");
		...
		reset : function() {
			a.console
					.error("[Drawer.reset] this function is deprecated. Use World.resetItems instead.");
			this.viewer.world.resetItems();
			return this
		},
		update : function() {
			a.console
					.error("[Drawer.update] this function is deprecated. Use Drawer.clear and World.draw instead.");
			this.clear();
		...
		viewportToDrawerRectangle : function(b) {
			...
			var d = this.viewport
					.deltaPixelsFromPointsNoRotate(b.getSize(), !0);
			return new a.Rect(c.x * a.pixelDensityRatio, c.y
							* a.pixelDensityRatio, d.x * a.pixelDensityRatio,
		...
		blendSketch : function(b, c, d, e) {
			...
			if (this.useCanvas && this.sketchCanvas) {
				...
				if (g) {
					...
					g.x + g.width > this.canvas.width
							&& (g.width = this.canvas.width - g.x);
					if (g.y < 0) {
						g.height += g.y;
						g.y = 0
					}
					g.y + g.height > this.canvas.height
							&& (g.height = this.canvas.height - g.y);
					this.context.drawImage(this.sketchCanvas, g.x, g.y,
							g.width, g.height, g.x, g.y, g.width, g.height)
				} else {
					c = f.scale || 1;
					d = f.translate;
					...
					this.context.drawImage(this.sketchCanvas, h.x - i * c, h.y
									- j * c, (this.canvas.width + 2 * i) * c,
							(this.canvas.height + 2 * j) * c, -i, -j,
							this.canvas.width + 2 * i, this.canvas.height + 2
									* j)
				}
		...
		drawDebugInfo : function(b, c, d, e) {
			if (this.useCanvas) {
				var f = this.viewer.world.getIndexOfItem(e)
						% this.debugGridColor.length;
				var g = this.context;
				g.save();
				g.lineWidth = 2 * a.pixelDensityRatio;
				g.font = "small-caps bold " + 13 * a.pixelDensityRatio
						+ "px arial";
				g.strokeStyle = this.debugGridColor[f];
				g.fillStyle = this.debugGridColor[f];
				...
				e.getRotation(!0) % 360 !== 0 && this._offsetForRotation({
							...
							point : e.viewport.pixelFromPointNoRotate(e
											._getRotationPoint(!0), !0)
						});
				g.strokeRect(b.position.x * a.pixelDensityRatio, b.position.y
								* a.pixelDensityRatio, b.size.x
								* a.pixelDensityRatio, b.size.y
								* a.pixelDensityRatio);
				var h = (b.position.x + b.size.x / 2) * a.pixelDensityRatio;
				var i = (b.position.y + b.size.y / 2) * a.pixelDensityRatio;
				g.translate(h, i);
				g.rotate(Math.PI / 180 * -this.viewport.degrees);
				g.translate(-h, -i);
				if (0 === b.x && 0 === b.y) {
					g.fillText("Zoom: " + this.viewport.getZoom(), b.position.x
									* a.pixelDensityRatio, (b.position.y - 30)
									* a.pixelDensityRatio);
					g.fillText("Pan: " + this.viewport.getBounds().toString(),
							b.position.x * a.pixelDensityRatio,
							(b.position.y - 20) * a.pixelDensityRatio)
				}
				g.fillText("Level: " + b.level, (b.position.x + 10)
								* a.pixelDensityRatio, (b.position.y + 20)
								* a.pixelDensityRatio);
				g.fillText("Column: " + b.x, (b.position.x + 10)
								* a.pixelDensityRatio, (b.position.y + 30)
								* a.pixelDensityRatio);
				g.fillText("Row: " + b.y, (b.position.x + 10)
								* a.pixelDensityRatio, (b.position.y + 40)
								* a.pixelDensityRatio);
				g.fillText("Order: " + d + " of " + c, (b.position.x + 10)
								* a.pixelDensityRatio, (b.position.y + 50)
								* a.pixelDensityRatio);
				g.fillText("Size: " + b.size.toString(), (b.position.x + 10)
								* a.pixelDensityRatio, (b.position.y + 60)
								* a.pixelDensityRatio);
				g.fillText("Position: " + b.position.toString(),
						(b.position.x + 10) * a.pixelDensityRatio,
						(b.position.y + 70) * a.pixelDensityRatio);
		...
		debugRect : function(b) {
			if (this.useCanvas) {
				...
				c.strokeStyle = this.debugGridColor[0];
				c.fillStyle = this.debugGridColor[0];
				c.strokeRect(b.x * a.pixelDensityRatio, b.y
								* a.pixelDensityRatio, b.width
								* a.pixelDensityRatio, b.height
								* a.pixelDensityRatio);
				c.restore()
			}
		},
		...
		_offsetForRotation : function(b) {
			var c = b.point ? b.point.times(a.pixelDensityRatio) : this
					.getCanvasCenter();
...
!function(a) {
	...
	a.Viewport.prototype = {
		...
		setHomeBounds : function(b, c) {
			a.console
					.error("[Viewport.setHomeBounds] this function is deprecated; The content bounds should not be set manually.");
		...
		getMinZoom : function() {
			var a = this.getHomeZoom(), b = this.minZoomLevel
					? this.minZoomLevel
		...
		getMaxZoom : function() {
			...
			if (!a) {
				a = this._contentSize.x * this.maxZoomPixelRatio
		...
		setMargins : function(b) {
			a.console.assert("object" === a.type(b),
		...
		getBoundsWithMargins : function(a) {
			return this.getBoundsNoRotateWithMargins(a).rotate(
					-this.getRotation(), this.getCenter(a))
		},
		...
		getCenter : function(b) {
			var c, d, e, f, g, h, i, j, k = new a.Point(
					this.centerSpringX.current.value,
					this.centerSpringY.current.value), l = new a.Point(
		...
		applyConstraints : function(a) {
			...
			(d.x !== e.x || d.y !== e.y || a)
					&& this.fitBounds(e.rotate(-this.getRotation()), a);
			return this
		},
		...
		_fitBounds : function(b, c) {
			...
			var g = b.getCenter();
			var h = new a.Rect(b.x, b.y, b.width, b.height, b.degrees
							+ this.getRotation()).getBoundingBox();
			h.getAspectRatio() >= f
					? h.height = h.width / f
					: h.width = h.height * f;
			h.x = g.x - h.width / 2;
			...
			var n = h.getTopLeft().times(i).minus(l.getTopLeft().times(m))
					.divide(i - m);
		...
		fitVertically : function(b) {
			var c = new a.Rect(this._contentBounds.x
							+ this._contentBounds.width / 2,
					this._contentBounds.y, 0, this._contentBounds.height);
			return this.fitBounds(c, b)
		},
		fitHorizontally : function(b) {
			var c = new a.Rect(this._contentBounds.x, this._contentBounds.y
							+ this._contentBounds.height / 2,
		...
		panBy : function(b, c) {
			var d = new a.Point(this.centerSpringX.target.value,
					this.centerSpringY.target.value);
		...
		zoomTo : function(b, c, d) {
			var e = this;
			this.zoomPoint = c instanceof a.Point && !isNaN(c.x) && !isNaN(c.y)
					? c
					: null;
		...
		setRotation : function(b) {
			...
			this._setContentBounds(this.viewer.world.getHomeBounds(),
		...
		update : function() {
			...
			var b = this.centerSpringX.current.value !== this._oldCenterX
		...
		deltaPixelsFromPoints : function(a, b) {
			return this.deltaPixelsFromPointsNoRotate(a.rotate(this
							.getRotation()), b)
		},
		...
		deltaPointsFromPixels : function(a, b) {
			return this.deltaPointsFromPixelsNoRotate(a, b).rotate(-this
					.getRotation())
		},
		...
		_pixelFromPointNoRotate : function(b, c) {
			return b.minus(c.getTopLeft()).times(this._containerInnerSize.x
					/ c.width).plus(new a.Point(this._margins.left,
					this._margins.top))
		},
		_pixelFromPoint : function(a, b) {
			return this._pixelFromPointNoRotate(a.rotate(this.getRotation(),
							this.getCenter(!0)), b)
		},
		pointFromPixelNoRotate : function(b, c) {
			var d = this.getBoundsNoRotate(c);
			return b.minus(new a.Point(this._margins.left, this._margins.top))
					.divide(this._containerInnerSize.x / d.width).plus(d
							.getTopLeft())
		},
		pointFromPixel : function(a, b) {
			return this.pointFromPixelNoRotate(a, b).rotate(
					-this.getRotation(), this.getCenter(!0))
		},
		_viewportToImageDelta : function(b, c) {
			var d = this._contentBoundsNoRotate.width;
			return new a.Point(b * this._contentSizeNoRotate.x / d, c
							* this._contentSizeNoRotate.x / d)
		},
		viewportToImageCoordinates : function(b, c) {
			if (b instanceof a.Point)
				return this.viewportToImageCoordinates(b.x, b.y);
			if (this.viewer) {
				var d = this.viewer.world.getItemCount();
				if (d > 1)
					a.console
							.error("[Viewport.viewportToImageCoordinates] is not accurate with multi-image; use TiledImage.viewportToImageCoordinates instead.");
				else if (1 === d) {
			...
			return this._viewportToImageDelta(
					b - this._contentBoundsNoRotate.x, c
		...
		imageToViewportCoordinates : function(b, c) {
			if (b instanceof a.Point)
				return this.imageToViewportCoordinates(b.x, b.y);
			if (this.viewer) {
				var d = this.viewer.world.getItemCount();
				if (d > 1)
					a.console
							.error("[Viewport.imageToViewportCoordinates] is not accurate with multi-image; use TiledImage.imageToViewportCoordinates instead.");
				else if (1 === d) {
					var e = this.viewer.world.getItemAt(0);
		...
		imageToViewportRectangle : function(b, c, d, e) {
			...
			if (this.viewer) {
				...
				if (g > 1)
					a.console
							.error("[Viewport.imageToViewportRectangle] is not accurate with multi-image; use TiledImage.imageToViewportRectangle instead.");
				else if (1 === g) {
		...
		viewportToImageRectangle : function(b, c, d, e) {
			...
			if (this.viewer) {
				...
				if (g > 1)
					a.console
							.error("[Viewport.viewportToImageRectangle] is not accurate with multi-image; use TiledImage.viewportToImageRectangle instead.");
				else if (1 === g) {
					var h = this.viewer.world.getItemAt(0);
		...
		viewerElementToViewportRectangle : function(b) {
			return a.Rect.fromSummits(this.pointFromPixel(b.getTopLeft(), !0),
					this.pointFromPixel(b.getTopRight(), !0), this
							.pointFromPixel(b.getBottomLeft(), !0))
		},
		viewportToViewerElementRectangle : function(b) {
			return a.Rect.fromSummits(this.pixelFromPoint(b.getTopLeft(), !0),
					this.pixelFromPoint(b.getTopRight(), !0), this
							.pixelFromPoint(b.getBottomLeft(), !0))
		},
		...
		viewportToImageZoom : function(b) {
			if (this.viewer) {
				...
				if (c > 1)
					a.console
							.error("[Viewport.viewportToImageZoom] is not accurate with multi-image.");
				else if (1 === c) {
		...
		imageToViewportZoom : function(b) {
			if (this.viewer) {
				...
				if (c > 1)
					a.console
							.error("[Viewport.imageToViewportZoom] is not accurate with multi-image.");
				else if (1 === c) {
					var d = this.viewer.world.getItemAt(0);
...
!function(a) {
	...
	function c(a, b, c, e, f, j, m, o, p, q, r, s) {
		var t = d(e, f, j, a, a.source, a.tilesMatrix, r, q,
				a._worldWidthCurrent, a._worldHeightCurrent), u = c;
		...
		if (t.loaded) {
			...
			t.loading ? a._tilesLoading++ : v || (s = n(s, t));
		return s
	}
	function d(b, c, d, e, f, g, h, i, j, k) {
		...
		if (!g[d][b][c]) {
			...
			if (e.loadTilesWithAjax) {
				...
				a.isPlainObject(e.ajaxHeaders)
						&& (q = a.extend({}, e.ajaxHeaders, q))
			} else
				q = null;
			r = f.getContext2D ? f.getContext2D(d, l, m) : void 0;
			n.x += (b - l) / i.x;
			n.y += k / j * ((c - m) / i.y);
			s = new a.Tile(d, b, c, n, o, p, r, e.loadTilesWithAjax, q);
			l === i.x - 1 && (s.isRightMost = !0);
			m === i.y - 1 && (s.isBottomMost = !0);
			g[d][b][c] = s
		}
		s = g[d][b][c];
		s.lastTouchTime = h;
	...
	function f(b, c, d, e, f, h) {
		if (e)
			if (d < b.lastResetTime) {
				a.console.log("Ignoring tile %s loaded before reset: %s", c,
						c.url);
				c.loading = !1
			} else {
				var i = function() {
			...
			/*a.console
					.log("Tile %s failed to load: %s - error: %s", c, c.url, f);*/
	...
	function h(b, c, d, e, f, g) {
		...
		var j = d.pixelFromPointNoRotate(h, !0), k = d.pixelFromPointNoRotate(
				h, !1), l = d.deltaPixelsFromPointsNoRotate(i, !0), m = d
				.deltaPixelsFromPointsNoRotate(i, !1), n = k.plus(m.divide(2)), o = e
				.squaredDistanceTo(n);
		c || (l = l.plus(new a.Point(1, 1)));
		b.isRightMost && g.wrapHorizontal && (l.x += .75);
		b.isBottomMost && g.wrapVertical && (l.y += .75);
		b.position = j;
		b.size = l;
		b.squaredDistance = o;
		b.visibility = f
	...
	function k(a, b, c, d) {
		return void 0 === c || void 0 === d ? j(a, b + 1) : j(a, b + 1, 2 * c,
				2 * d)
				&& j(a, b + 1, 2 * c, 2 * d + 1)
				&& j(a, b + 1, 2 * c + 1, 2 * d)
				&& j(a, b + 1, 2 * c + 1, 2 * d + 1)
	...
	function n(a, b) {
		return a ? b.visibility > a.visibility
				? b
				: b.visibility == a.visibility
						&& b.squaredDistance < a.squaredDistance ? b : a : b
	}
	function o(b, c) {
		if (0 !== b.opacity && (0 !== c.length || b.placeholderFillStyle)) {
			...
			var e;
			d
					&& (e = b.opacity < 1 || b.compositeOperation
							&& "source-over" !== b.compositeOperation
							|| !b._isBottomItem()
			...
			if (c.length > 1 && i > b.smoothTileEdgesMinZoom && !b.iOSDevice
					&& b.getRotation(!0) % 360 === 0 && a.supportsCanvas) {
				e = !0;
				f = d.getScaleForEdgeSmoothing();
				g = d
						.getTranslationForEdgeSmoothing(f, b._drawer
										.getCanvasSize(!1), b._drawer
										.getCanvasSize(!0))
			}
			var j;
			if (e) {
				f
						|| (j = b.viewport.viewportToViewerElementRectangle(b
								.getClippedBounds(!0)).getIntegerBoundingBox()
								.times(a.pixelDensityRatio));
			...
			if (!f) {
				...
				b.getRotation(!0) % 360 !== 0 && b._drawer._offsetForRotation({
							...
							point : b.viewport.pixelFromPointNoRotate(b
											._getRotationPoint(!0), !0),
							useSketch : e
						})
			}
			...
			if (b.placeholderFillStyle && b._hasOpaqueTile === !1) {
				...
				g && (n = n.translate(g));
				var o = null;
				o = "function" == typeof b.placeholderFillStyle
						? b.placeholderFillStyle(b, b._drawer.context)
						: b.placeholderFillStyle;
			...
			if (!f) {
				b.getRotation(!0) % 360 !== 0
						&& b._drawer._restoreRotationChanges(e);
			...
			if (e) {
				...
				if (f) {
					b.getRotation(!0) % 360 !== 0
							&& b._drawer._restoreRotationChanges(!1);
					0 !== b.viewport.degrees
							&& b._drawer._restoreRotationChanges(!1)
				}
			}
	...
	a.TiledImage = function(b) {
		...
		if (b.width) {
			...
			if (b.height) {
				a.console
						.error("specifying both width and height to a tiledImage is not supported");
				delete b.height
			}
		} else if (b.height) {
	...
	a.extend(a.TiledImage.prototype, a.EventSource.prototype, {
		...
		getBounds : function(a) {
			return this.getBoundsNoRotate(a).rotate(this.getRotation(a),
					this._getRotationPoint(a))
		},
		getBoundsNoRotate : function(b) {
			return b ? new a.Rect(this._xSpring.current.value,
					this._ySpring.current.value, this._worldWidthCurrent,
					this._worldHeightCurrent) : new a.Rect(
					this._xSpring.target.value, this._ySpring.target.value,
					this._worldWidthTarget, this._worldHeightTarget)
		},
		getWorldBounds : function() {
			a.console
					.error("[TiledImage.getWorldBounds] is deprecated; use TiledImage.getBounds instead");
		...
		getContentSize : function() {
			return new a.Point(this.source.dimensions.x,
		...
		_viewportToImageDelta : function(b, c, d) {
			...
			return new a.Point(b * (this.source.dimensions.x / e),
					c * (this.source.dimensions.y * this.contentAspectX / e))
		},
		viewportToImageCoordinates : function(b, c, d) {
			...
			return d ? this._viewportToImageDelta(e.x
							- this._xSpring.current.value, e.y
							- this._ySpring.current.value) : this
					._viewportToImageDelta(e.x - this._xSpring.target.value,
		...
		_imageToViewportDelta : function(b, c, d) {
			var e = d
					? this._scaleSpring.current.value
					: this._scaleSpring.target.value;
			return new a.Point(b / this.source.dimensions.x * e, c
		...
		imageToViewportRectangle : function(b, c, d, e, f) {
			...
			return new a.Rect(h.x, h.y, i.x, i.y, g.degrees
							+ this.getRotation(f))
		},
		...
		imageToWindowCoordinates : function(a) {
			...
			return b
					.plus(OpenSeadragon.getElementPosition(this.viewer.element))
		},
		_viewportToTiledImageRectangle : function(b) {
			...
			return new a.Rect((b.x - this._xSpring.current.value) / c,
					(b.y - this._ySpring.current.value) / c, b.width / c,
					b.height / c, b.degrees)
		},
		viewportToImageZoom : function(a) {
			var b = this._scaleSpring.current.value
		...
		setPosition : function(a, b) {
			var c = this._xSpring.target.value === a.x
					&& this._ySpring.target.value === a.y;
			if (b) {
				if (c && this._xSpring.current.value === a.x
						&& this._ySpring.current.value === a.y)
					return;
		...
		fitBounds : function(b, c, d) {
			...
			if (b.getAspectRatio() > f) {
				var k = b.height / j;
				var l = 0;
				e.isHorizontallyCentered
						? l = (b.width - b.height * f) / 2
						: e.isRight && (l = b.width - b.height * f);
				this.setPosition(new a.Point(b.x - g + l, b.y - h), d);
				this.setHeight(k, d)
			} else {
				var m = b.width / i;
				var n = 0;
				e.isVerticallyCentered
						? n = (b.height - b.width / f) / 2
						: e.isBottom && (n = b.height - b.width / f);
		...
		setRotation : function(a, b) {
			if (this._degreesSpring.target.value !== a
					|| !this._degreesSpring.isAtTargetValue()) {
				b ? this._degreesSpring.resetTo(a) : this._degreesSpring
						.springTo(a);
				this._needsDraw = !0;
		...
		_setScale : function(a, b) {
			...
			if (b) {
				if (c && this._scaleSpring.current.value === a)
					return;
		...
		_updateForScale : function() {
			...
			this._worldHeightTarget = this.normHeight
					* this._scaleSpring.target.value;
			this._worldWidthCurrent = this._scaleSpring.current.value;
			this._worldHeightCurrent = this.normHeight
					* this._scaleSpring.current.value
		},
		...
		_getLevelsInterval : function() {
			var a = Math.max(this.source.minLevel, Math.floor(Math
							.log(this.minZoomImageRatio)
							/ Math.log(2)));
			var b = this.viewport.deltaPixelsFromPointsNoRotate(this.source
							.getPixelRatio(0), !0).x
					* this._scaleSpring.current.value;
			var c = Math.min(Math.abs(this.source.maxLevel), Math.abs(Math
							.floor(Math.log(b / this.minPixelRatio)
									/ Math.log(2))));
			a = Math.min(a, c);
			return {
				lowestLevel : a,
		...
		_updateViewport : function() {
			...
			var d = this.viewport;
			var f = this._viewportToTiledImageRectangle(d
					.getBoundsWithMargins(!0));
			if (!this.wrapHorizontal && !this.wrapVertical) {
				var g = this._viewportToTiledImageRectangle(this
						.getClippedBounds(!0));
				f = f.intersection(g);
				if (null === f)
					return
			...
			for (var p = k; p >= i; p--) {
				var q = !1;
				var r = d.deltaPixelsFromPointsNoRotate(this.source
								.getPixelRatio(p), !0).x
						* this._scaleSpring.current.value;
				if (p === i || !m && r >= this.minPixelRatio) {
					...
					continue;
				var s = d.deltaPixelsFromPointsNoRotate(this.source
								.getPixelRatio(p), !1).x
						* this._scaleSpring.current.value;
				var t = d.deltaPixelsFromPointsNoRotate(this.source
								.getPixelRatio(Math.max(this.source
												.getClosestLevel(), 0)), !1).x
						* this._scaleSpring.current.value;
				var u = this.immediateRender ? 1 : t;
				var v = Math.min(1, (r - .5) / .5);
				var w = u / Math.abs(u - s);
				l = b(this, m, q, p, v, w, f, n, l);
				if (j(this.coverage, p))
					break
			}
...
!function(a) {
	var b = function(b) {
		...
		a.console.assert(b.tile,
				"[TileCache.cacheTile] options.tile is required");
		a.console.assert(b.tiledImage,
	...
	a.TileCache = function(b) {
		b = b || {};
		this._maxImageCacheCount = b.maxImageCacheCount
				|| a.DEFAULT_SETTINGS.maxImageCacheCount;
		this._tilesLoaded = [];
		this._imagesLoaded = [];
	...
	a.TileCache.prototype = {
		...
		cacheTile : function(d) {
			...
			a.console.assert(d.tile,
					"[TileCache.cacheTile] options.tile is required");
			a.console.assert(d.tile.cacheKey,
					"[TileCache.cacheTile] options.tile.cacheKey is required");
			a.console.assert(d.tiledImage,
					"[TileCache.cacheTile] options.tiledImage is required");
			var e = d.cutoff || 0;
...
!function(a) {
	...
	a.extend(a.World.prototype, a.EventSource.prototype, {
				addItem : function(b, c) {
					...
					a.console
							.assert(b instanceof a.TiledImage,
									"[World.addItem] only TiledImages supported at this time");
					c = c || {};
					if (void 0 !== c.index) {
						var d = Math.max(0, Math.min(this._items.length,
										c.index));
				...
				setItemIndex : function(b, c) {
					a.console
							.assert(b, "[World.setItemIndex] item is required");
					a.console.assert(void 0 !== c,
				...
				removeItem : function(b) {
					...
					if (c !== -1) {
						b.removeHandler("bounds-change",
								this._delegatedFigureSizes);
						b.removeHandler("clip-change",
								this._delegatedFigureSizes);
						b.destroy();
				...
				removeAll : function() {
					...
					for (b = 0; b < this._items.length; b++) {
						a = this._items[b];
						a.removeHandler("bounds-change",
								this._delegatedFigureSizes);
						a.removeHandler("clip-change",
								this._delegatedFigureSizes);
						a.destroy()
					}
					var c = this._items;
				...
				arrange : function(b) {
					...
					var h = b.tileMargin
							|| a.DEFAULT_SETTINGS.collectionTileMargin;
					var i = g + h;
					var j;
				...
				_figureSizes : function() {
					...
					if (this._items.length) {
						...
						this._contentSize = new a.Point(this._homeBounds.width
										* this._contentFactor,
					...
					this._contentFactor === d && this._homeBounds.equals(b)
							&& this._contentSize.equals(c)
