...
(function() {
    ...
    var Overlay = function(viewer) {
        ...
        //document.getElementById('#openSeadragon').appendChild(this._canvasdiv);
        ...
        //this._canvas.setAttribute('renderOnAddRemove', false);
        ...
        this._fabricCanvas.on('mouse:down', function (options) {
            if (options.target) {
                ...
                options.e.preventDefaultAction = false;
