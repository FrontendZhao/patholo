...
<div class='flipbook' style='position: relative; width: 100%; height: 100%; transform: translate3d(0px, 0px, 0px); margin-left: 0px;'>
			...
			<div class='page-content' ><div style="float: left;">
									...
									<div class='grade-title'>
										<div class='grade-title-text'>第十六章 传染病</div>
									</div>
									<div class='chapter-title'>
										<div class='chapter-title-no'>16.1</div>
										<div class='chapter-title-text'>结核</div>
									</div>
									<div class='section'>
									...
									<div class='chapter-title'>
										<div class='chapter-title-no'>16.2</div>
										<div class='chapter-title-text'>仿寒</div>
									</div>
									<div class='section'>
										<ul class='section-title'>
											<li class='order-11'></li>
									...
									<div class='chapter-title'>
										<div class='chapter-title-no'>16.3</div>
										<div class='chapter-title-text'>细菌性痢疾</div>
									</div>
