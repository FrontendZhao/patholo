...
<div class='flipbook' style='position: relative; width: 100%; height: 100%; transform: translate3d(0px, 0px, 0px); margin-left: 0px;'>
			...
			<div class='page-content' style='overflow:hidden;height:572px;' >
									...
									<div class='chapter-title' style="margin-top: 20px;">
										<div class='chapter-title-no'>8.2</div>
										<div class='chapter-title-text'>高血压病</div>
									</div>
									<div class='section'>
									...
									<div class='chapter-title'>
										<div class='chapter-title-no'>8.3</div>
										<div class='chapter-title-text'>风湿病及心脏瓣膜病</div>
									</div>
									<div class='section'>
										<ul class='section-title'>
											<li class='order-11'></li>
									...
									<div class='grade-title'>
										<div class='grade-title-text'>第九章 呼吸系统疾病</div>
									</div>
									<div class='chapter-title'>
										<div class='chapter-title-no'>9.1</div>
										<div class='chapter-title-text'>慢性阻塞性肺疾病及肺心病</div>
									</div>
									<div class='section'>
										<ul class='section-title'>
											<li class='order-11'></li>
									...
									<div class='chapter-title'>
										<div class='chapter-title-no'>9.2</div>
										<div class='chapter-title-text'>肺炎</div>
									</div>
									<div class='section'>
										<ul class='section-title'>
											<li class='order-11'></li>
