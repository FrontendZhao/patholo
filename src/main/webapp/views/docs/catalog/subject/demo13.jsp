...
<div class='flipbook' style='position: relative; width: 100%; height: 100%; transform: translate3d(0px, 0px, 0px); margin-left: 0px;'>
			...
			<div class='page-content'  ><div style="float: left;">
									...
									<div class='chapter-title top-section'>
										<div class='chapter-title-no'>12.1</div>
										<div class='chapter-title-text'>肾小球疾病</div>
									</div>
									<div class='section'>
									...
									<div class='chapter-title'>
										<div class='chapter-title-no'>12.2</div>
										<div class='chapter-title-text'>肾小管和肾间疾病</div>
									</div>
									<div class='section'>
										<ul class='section-title'>
											<li class='order-11'></li>
									...
									<div class='grade-title'>
										<div class='grade-title-text'>第十三章 生殖系统和乳腺疾病</div>
									</div>
									<div class='chapter-title'>
										<div class='chapter-title-no'>13.1</div>
										<div class='chapter-title-text'>子宫疾病</div>
									</div>
