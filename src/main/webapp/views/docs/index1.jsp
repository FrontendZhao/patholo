...
<link href="${ctx}/views/docs/css/style.css" type="text/css"
...
<body>
			...
			<div class="services-agileinfo">
				<div class="col-sm-3 col-xs-6 wthree-services-grid">
					<div class="wthree-services-icon">
						<a href="${ctx}/views/docs/exam/example.jsp?exampleNo=0"
							target="_blank"><img src="images/0000_0000.jpg" alt="图片找不到啦"
							class="img-thumbnail"></a>
					</div>
					<div class="wthree-services-info">
						<h5>实例1</h5>
						<p>Donec sed nisi leo. Ut at sagittis nisi. Cras porttitor a
							purus ac rutrum.</p>
					</div>
				</div>
				<div class="col-sm-3 col-xs-6 wthree-services-grid">
					<div class="wthree-services-icon">
						<a href="${ctx}/views/docs/exam/example.jsp?exampleNo=1"
							target="_blank"><img src="images/0000_0000.png" alt="图片找不到啦"
							class="img-thumbnail"></a>
					</div>
					<div class="wthree-services-info">
						<h5>实例2</h5>
	...
	<div id="gallery" class="">
		<div class="container">
			...
			<div class="">
				<div id="1"
					class="col-sm-2 col-xs-3 col-xs-offset-2 col-sm-offset-1">
					<div class="grid effect-apollo">
						<a href="../docs/catalog/subject/subject1.jsp?subNo='+val.id+'"><img
							src="/filePath/subject/1/1.jpg" alt="图片找不到啦" />
	...
	<div id="about" class="welcome">
		<div class="container">
			...
			<h4>In education, a teacher is a person who provides schooling
				for others. A teacher who facilitates education for an individual
				student may also be described as a personal tutor or profession at a
				school or other place of formal education.</h4>
			<p class="w-text">Lorem ipsum dolor sit amet, consectetur
				adipiscing elit. Integer gravida mauris non mi gravida, at
				sollicitudin odio efficitur. Mauris ex nulla, aliquam ornare
				facilisis nec convallis pulvinar a non nunc non leo sollicitudin</p>
		</div>
	</div>
	<div class="team jarallax">
		<div class="carousel-example">
			<!-- FLEXIBLE BOOTSTRAP CAROUSEL -->
			<div id="simple-content-carousel" class="carousel flexible slide"
				...
				<a class="left carousel-control" href="#simple-content-carousel"
					role="button" data-slide="prev"> <span class="fa fa-angle-left"
					aria-hidden="true"></span> <span class="sr-only">上一张</span>
				</a> <a class="right carousel-control" href="#simple-content-carousel"
					role="button" data-slide="next"> <span
					class="fa fa-angle-right" aria-hidden="true"></span> <span
					class="sr-only">下一张</span>
				</a>
			</div>
		</div>
	</div>
